                  ...
                  if (row){
                    ...
                    <tr key={rowNumber}>
                      {Object.keys(row)?.map(key => (
                        <td>
                          <input onChange={(e) => props.fieldChangeHandler(e, props.selectedTable, rowNumber, key)} className='table-field' type="text" name={key} id={key+rowNumber} key={key+rowNumber} defaultValue={row[key]} />
                        </td>
                      ))}
